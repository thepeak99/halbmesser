...
function auth_mschapv2(params, attrs, cb) {
    ...
    authenticatorChallenge = params.req.attributes['MS-CHAP-Challenge'];
    peerChallenge = params.req.attributes['MS-CHAP2-Response'].slice(2, 18);
    ntResponse = params.req.attributes['MS-CHAP2-Response'].slice(26);
    ident = params.req.attributes['MS-CHAP2-Response'][0];
    ...
    if (buffertools.equals(ntResponse, myNtResponse)) {
        ...
        out = new Buffer(44);
        out.writeUInt8(ident);
        out.writeUInt8(0, 1);
        out.write(authenticatorResponse, 2);
        params.res.attributes['MS-CHAP-Success'] = out;
    }
}
